...
**Dictamen:** MITL + firmas **firmadas 18-08-2026**. Siguiente: PROMOTE → postprod → tag.
...
9. Deploy fase `target=production`, `expected_sha=ffd975d`, `confirmation=PROMOTE`. ☐ **en curso**
...
- [ ] Aprobar entorno GitHub `Production` si el workflow PROMOTE lo solicita
- [ ] Smoke postprod `https://alexendros.dev`
- [ ] Tag `v1.0.0` (workflow Release)
