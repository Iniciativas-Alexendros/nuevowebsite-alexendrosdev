...
6. QA MITL + a11y: bloques 0–1 decisor ✅; Playwright preview ✅ — **firma formal pendiente** (`docs/p8-2-a11y-audit.md`).
7. ~~Smoke SMTP → bandeja `operaciones@`.~~ ✅ 18-08 (From=`operaciones@`, Reply-To=email formulario; ADR-0011)
8. Firmar Fases 5, 6, 7, 7.z, 8 (P6-R3 confidencialidad). ☐ **decisor**
...
- [ ] Firma MITL / P8-2 (`docs/p8-2-a11y-audit.md`) tras revisar preview restaurada
- [ ] Firmas épicas Fases 5–8 (DEC-ROADMAP-03)
