...
export const profile = profileSchema.parse({
  ...
  bio: [
    ...
    "Creo en código que se entiende, se prueba y se mantiene. TypeScript estricto, Zod en fronteras, tests unitarias/E2E, CI con gates bloqueantes (typecheck, lint, test, build, axe-core, Lighthouse CI). Despliegue en Vercel, previews por PR, producción desde rama protegida.",
    ...
    "Servicios: desarrollo web a medida, landing pages con A/B nativo, automatización y agentes IA (MCP, CLI locales), auditoría web (rendimiento, accesibilidad, SEO técnico, seguridad). Conversión principal: formulario de contacto validado en cliente y servidor.",
  ...
  links: [
    { label: "GitHub", href: "https://github.com/Iniciativas-Alexendros", external: true },
    { label: "LinkedIn", href: "https://linkedin.com/in/alexendros", external: true },
    { label: "Email", href: "mailto:hola@alexendros.dev", external: true },
    { label: "Cal.com", href: "https://cal.com/alexendros", external: true },
  ],
  status: "published",
  metadata: {
